...
from ball_detector import ColorBasedBallDetector, HybridBallDetector, BallDetector
...
def initialize_system():
    ...
    try:
        ...
        if config.USE_HAILO_DETECTION:
            ball_detector = HybridBallDetector()
            logger.info("Using hybrid ball detection (Hailo + Color)")
        else:
            ball_detector = ColorBasedBallDetector()
            logger.info("Using color-based ball detection")
...
def start_system():
    ...
    try:
        ...
        logger.info(f"Detection Method: {'Hybrid (Hailo + Color)' if config.USE_HAILO_DETECTION else 'Color-based'}")
