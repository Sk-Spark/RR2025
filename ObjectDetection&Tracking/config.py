...
# Camera settings
CAMERA_RESOLUTION = (1280, 1280)  # Width, Height - square format for better Hailo compatibility
CAMERA_FRAMERATE = 30  # Frames per second
CAMERA_ROTATION = 0  # Rotation in degrees (0, 90, 180, 270)

# Ball detection settings
BALL_COLOR_HSV_LOWER = (10, 100, 100)  # Lower HSV values for orange ping pong ball
BALL_COLOR_HSV_UPPER = (20, 255, 255)  # Upper HSV values for orange ping pong ball
BALL_MIN_RADIUS = 10  # Minimum ball radius in pixels
BALL_MAX_RADIUS = 100  # Maximum ball radius in pixels
BLUR_KERNEL_SIZE = 11  # Kernel size for Gaussian blur
MORPHOLOGY_KERNEL_SIZE = 5  # Kernel size for morphological operations

# Alternative: Use Hailo NPU for sports ball detection
USE_HAILO_DETECTION = True  # Set to False to use color-based detection
