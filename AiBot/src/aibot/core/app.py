...
from ..agents.ollama_agent import OllamaBotAgent
...
class BotControlApp:
    """Main bot control application with orchestrator communication."""
    
    def __init__(self, config_manager: Optional[ConfigManager] = None):
        """Initialize the bot control application."""
        self.config_manager = config_manager or ConfigManager()
        self.agent: Optional[OllamaBotAgent] = None
        self.orchestrator_client: Optional[OrchestratorClient] = None
        self.logger = logging.getLogger(__name__)
        self.agent_id = f"rpi_bot_{uuid.uuid4().hex[:8]}"
    ...
    def print_welcome(self) -> None:
        ...
        print("🤖 AiBot - Intelligent Robot Control Agent")
        print("=" * 50)
