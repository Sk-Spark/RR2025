...
class HailoObjectDetector:
    ...
    def detect(self, frame):
        ...
        try:
            # Get original frame dimensions for scaling results back
            ...
            results = self.hailo.run(resized_frame)
            
            # Extract detections and scale back to original frame size
            detections = extract_detections(
                results, orig_w, orig_h, self.class_names, self.confidence_threshold
            )
